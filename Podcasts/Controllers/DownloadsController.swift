...
//  Podcasts
//
//  Created by Ömer Faruk Ercivan on 14.07.2023.
//
...
class DownloadsController: UITableViewController {
    ...
    fileprivate func setupObserver() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(handleDownloadComplete), name: .downloadComplate, object: nil)
    }
